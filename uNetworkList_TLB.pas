...
// $Rev: 98336 $
// File generated on 2026-02-05 09:19:21 AM from Type Library described below.
...
const
  ...
  IID_INetwork2: TGUID = '{B5550ABB-3391-4310-804F-25DCC325ED81}';
  IID_IErrorLog: TGUID = '{3127CA40-446E-11CE-8135-00AA004BB851}';
  IID_INetworkConnection2: TGUID = '{00E676ED-5A35-4738-92EB-8581738D0F0A}';
...
// Constants for enum NLM_DOMAIN_AUTHENTICATION_KIND
type
  NLM_DOMAIN_AUTHENTICATION_KIND = TOleEnum;
const
  NLM_DOMAIN_AUTHENTICATION_KIND_NONE = $00000000;
  NLM_DOMAIN_AUTHENTICATION_KIND_LDAP = $00000001;
  NLM_DOMAIN_AUTHENTICATION_KIND_TLS = $00000002;
...
// *********************************************************************//
  ...
  INetwork2 = interface;
  INetwork2Disp = dispinterface;
  IErrorLog = interface;
  INetworkConnection2 = interface;
  INetworkConnection2Disp = dispinterface;
...
// *********************************************************************//
  INetwork2 = interface(INetwork)
    ['{B5550ABB-3391-4310-804F-25DCC325ED81}']
    function IsDomainAuthenticatedBy(domainAuthenticationKind: NLM_DOMAIN_AUTHENTICATION_KIND): Integer; safecall;
  end;

// *********************************************************************//
// DispIntf:  INetwork2Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {B5550ABB-3391-4310-804F-25DCC325ED81}
// *********************************************************************//
  INetwork2Disp = dispinterface
    ['{B5550ABB-3391-4310-804F-25DCC325ED81}']
    function IsDomainAuthenticatedBy(domainAuthenticationKind: NLM_DOMAIN_AUTHENTICATION_KIND): Integer; dispid 14;
    function GetName: WideString; dispid 1;
    procedure SetName(const szNetworkNewName: WideString); dispid 2;
    function GetDescription: WideString; dispid 3;
    procedure SetDescription(const szDescription: WideString); dispid 4;
...
// *********************************************************************//
  INetworkConnection2 = interface(INetworkConnection)
    ['{00E676ED-5A35-4738-92EB-8581738D0F0A}']
    function IsDomainAuthenticatedBy(domainAuthenticationKind: NLM_DOMAIN_AUTHENTICATION_KIND): Integer; safecall;
  end;

// *********************************************************************//
// DispIntf:  INetworkConnection2Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {00E676ED-5A35-4738-92EB-8581738D0F0A}
// *********************************************************************//
  INetworkConnection2Disp = dispinterface
    ['{00E676ED-5A35-4738-92EB-8581738D0F0A}']
    function IsDomainAuthenticatedBy(domainAuthenticationKind: NLM_DOMAIN_AUTHENTICATION_KIND): Integer; dispid 8;
    function GetNetwork: INetwork; dispid 1;
    property IsConnectedToInternet: WordBool readonly dispid 2;
    property IsConnected: WordBool readonly dispid 3;
    function GetConnectivity: NLM_CONNECTIVITY; dispid 4;
